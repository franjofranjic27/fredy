import { createClaudeClient, createOllamaClient } from "@fredy/llm";
import {
  ToolRegistry,
  fetchUrlTool,
...
export function createToolRegistry(): ToolRegistry {
  const tools = new ToolRegistry().register(fetchUrlTool).register(
    createKnowledgeBaseStatsTool({
...
export function createAgentConfig(overrides: { verbose?: boolean } = {}): AgentConfig {
